...
function FileTab() {
  ...
  return (
    <div
      className="flex h-[50px] w-fullselect-none gap-2 overflow-x-auto p-2 pb-0 bg-[#181818]"
      ref={fileTabRef}
    >
      {openFiles.map((file) => (
        <span
          ...
          className={cn(
            ...
            { "bg-[#2B2B2B]": file.id === activeFile?.id }
          )}
        ...
        >
          ...
          <IoClose
            className="ml-3 inline rounded-md hover:bg-red-800"
            size={20}
