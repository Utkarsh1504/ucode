  ...
  return (
    ...
    >
      ...
      >
        <hr />
        <button
          className="mt-2 flex w-full justify-start rounded-md p-2 transition-all hover:bg-gray-800"
        ...
        <button
          className="flex w-full justify-start rounded-md p-2 transition-all hover:bg-gray-800"
