...
function FileStructureView() {
  ...
  return (
    <div onClick={handleClickOutside} className="flex flex-grow flex-col">
      <div className="view-title flex mb-2 justify-between">
        <h2>Files</h2>
        <div className="flex gap-2">
          <button
            className="rounded-md px-1 hover:bg-gray-800"
...
function Directory({
  ...
  return (
    <div className="overflow-x-auto">
      <div
        className="flex w-full items-center rounded-md px-2 py-1 hover:bg-gray-800"
...
const FileMenu = ({
  ...
  return (
    <div
      className="absolute z-10 w-[150px] rounded-md border border-gray-800 bg-gray-800 p-1"
      style={{
        top,
        left,
      }}
    >
      <button
        ...
        className="flex w-full items-center gap-2 rounded-md px-2 py-1 hover:bg-gray-800"
      >
      ...
      <button
        ...
        className="flex w-full items-center gap-2 rounded-md px-2 py-1 text-red-600 hover:bg-gray-800"
      >
        <MdDelete size={20} />
        Delete
      </button>
...
const DirectoryMenu = ({
  ...
  return (
    <div
      className="absolute z-10 w-[150px] rounded-md border border-blue-600 bg-gray-800 p-1"
      style={{
        top,
        left,
      }}
